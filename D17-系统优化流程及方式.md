...
| **关联** | [`D00`](D00-文档索引与编号规范.md)、[`D04`](D04-开源框架选型评估.md)、[`D05`](D05-系统功能清单.md)、[`D06`](D06-Mxxx实现映射表.md)、[`D07`](D07-总体技术架构设计.md)、[`D16`](D16-基线与外部依赖确认单.md)、[`D20`](D20-模块实用化与交互验收标准.md)、[`功能清单.xlsx`](功能清单.xlsx) |
