-- V211: 数据融合治理平台 — 一级菜单「数据指标」及三子菜单（复用人口共享区指标库能力）
-- 侧栏 key：indicator.domains / groups / tasks → /governance?tab=indicator&iSub=...
...
-- 赋权：已拥有治理平台任一叶子菜单的角色，同步勾选数据指标三叶；系统管理员另全量补齐
