...
| **文本依据** | [`extracts/_doc_extract.txt`](extracts/_doc_extract.txt)（Word 全文提取，约 6.9 万字） |
| **评估日期** | 2026-06-22 |
...
2. 现有 **ESB** 品牌、环境、接口文档 — **已提供**（[`ESB接口说明文档.docx`](vendor/ESB接口说明文档.docx)、[`D03-ESB集成说明.md`](D03-ESB集成说明.md)）；待确认生产环境地址  
