...
3. 添加系统环境变量 `PENTAHO_JAVA_HOME`，值为 JDK 根目录。
4. 将数据库连接驱动 jar 拷贝到 `data-integration/lib` 目录。
...
| 版本 | 日期 | 说明 |
|------|------|------|
| V1.0 | 2026-08-07 | 自飞书文档整理入库；补充与本项目 D23 / `KETTLE_URL` 对照；图片与附件保留文件名引用 |
