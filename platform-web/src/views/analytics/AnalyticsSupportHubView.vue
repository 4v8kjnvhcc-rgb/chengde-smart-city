...
interface SystemLink { mCode: string; label: string; route: string }
...
<template>
  <div>
    ...
    <el-tabs v-model="tab" type="border-card">
      <el-tab-pane label="用户中心" name="users">
        <PageCard title="M139 用户中心">
      ...
      <el-tab-pane label="认证中心" name="auth">
        <PageCard title="M141 认证中心（SSO 扩展）">
      ...
      <el-tab-pane label="服务中心" name="services">
        <PageCard title="M142 服务中心">
          <el-form inline>
      ...
      <el-tab-pane label="系统管理" name="config">
        <PageCard title="M143 系统管理">
